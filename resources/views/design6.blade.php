...
@section('content')
    ...
    <div class="row">
        ...
        <div class="list-group list" id="listmenu">
            ...
            <button type="button" class="list-group-item list-group-item-action active" id="itemMateri6" onclick="window.location.href = '/design/6';">Materi Design 6</button>
            ...
            <div class="container materi">
                ...
                <div class="d-flex justify-content-end">
                    <form action="{{ route('pelajaran') }}" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" name="lesson"  value="70">
