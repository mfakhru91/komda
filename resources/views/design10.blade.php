...
@section('content')
    ...
    <div class="row">
        ...
        <div class="list-group list" id="listmenu">
            ...
            <button type="button" class="list-group-item list-group-item-action " id="itemMateri5" onclick="window.location.href = '/design/5';">Materi Design 5</button>
            ...
            <button type="button" class="list-group-item list-group-item-action active" id="itemMateri10" onclick="window.location.href = '/design/10';">Materi Design 10</button>
        </div>
        </div>
            ...
            <div class="container materi">
                ...
                <div class="d-flex justify-content-end">
                    <form action="{{ route('pelajaran') }}" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" name="lesson"  value="100">
